...
def test_hurst_feature_metadata_contains_required_keys(brownian_motion: np.ndarray) -> None:
...
def test_hurst_feature_float32_preserves_accuracy(brownian_motion: np.ndarray) -> None:
    ...
    assert abs(result_64.value - result_32.value) < 0.2, \
...
def test_hurst_feature_float32_metadata_not_present_by_default(brownian_motion: np.ndarray) -> None:
